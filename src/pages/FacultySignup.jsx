            ...
            <AnimatePresence mode="wait">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                ...
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-sm md:text-base font-medium">
                  Manage your digital classrooms, student grades database, reviewcapstone timelines, and organize classroom attendance metrics. Focus on teaching, we handle the workflow.
                </p>
          ...
          <div className="my-auto max-w-md w-full mx-auto space-y-8 pt-8">
            ...
            <div className="p-3.5 rounded-2xl border border-slate-200/60 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/30 flex items-start gap-3">
              ...
              <div className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed font-semibold">
                <span>FACULTY signup verification requires standard accounts ending with <strong className={theme.textAccent}>@gmail.com</strong></span>
              </div>
            </div>
            ...
            <form onSubmit={handleSignupSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-2 font-mono">College Name</label>
                <div className="relative">
                  <input type="text" value={collegeName} onChange={(e) => setCollegeName(e.target.value)} placeholder="e.g. MuTeX College" className={`w-full px-4 py-3.5 rounded-2xl bg-slate-100/60 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 focus:outline-none focus:ring-2 focus:ring-opacity-35 transition-all text-sm font-semibold ${theme.borderFocus}`} />
                </div>
              </div>
            ...
            <div className="text-center pt-2">
              <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">
                ...
                <Link to="/faculty-login" className={`hover:underline cursor-pointer ${theme.textAccent}`}>
                  Sign in instead
                </Link>
              </p>
            </div>
            ...
            <div className="text-center pt-2">
              <Link to="/student-signup" className="text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 flex items-center justify-center gap-1.5 transition-colors">
