            ...
            <AnimatePresence mode="wait">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                <div className={`text-xs font-bold uppercase tracking-wider ${theme.textAccent} font-mono flex items-center gap-2`}>
                  <Sparkles className="w-4 h-4" /> Tailored Professional Space
                </div>
          ...
          <div className="my-auto max-w-md w-full mx-auto space-y-8 pt-8">
            ...
            <div className="p-3.5 rounded-2xl border border-slate-200/60 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/30 flex items-start gap-3">
              ...
              <div className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed font-semibold">
                <span>STUDENT signup verification requires standard accounts ending with <strong className={theme.textAccent}>@gmail.com</strong></span>
              </div>
            </div>
            ...
            <div className="text-center pt-2">
              <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">
                ...
                <Link to="/student-login" className={`hover:underline cursor-pointer ${theme.textAccent}`}>
                  Sign in instead
                </Link>
              </p>
            </div>
            ...
            <div className="text-center pt-2">
              <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">
                <Link to="/faculty-signup" className="hover:underline hover:text-emerald-500 transition-colors">Faculty Signup</Link>
                <span className="mx-2">|</span>
                <Link to="/admin-signup" className="hover:underline hover:text-rose-500 transition-colors">Admin Signup</Link>
              </p>
            </div>
