      ...
      <div className="w-full flex min-h-screen">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-between p-6 md:p-12 relative z-10 bg-white/40 dark:bg-slate-950/20 backdrop-blur-sm">
          ...
          <div className="my-auto max-w-md w-full mx-auto space-y-8 pt-8">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Link to="/admin-forgot-password" className={`text-[11px] font-bold hover:underline cursor-pointer ${theme.textAccent}`}>Forgot Password?</Link>
                </div>
                <div className="relative">
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 text-xs font-semibold text-slate-500 dark:text-slate-400 cursor-pointer select-none">
                  <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className={`w-4 h-4 rounded border-slate-300 text-rose-600 focus:ring-rose-500 focus:ring-opacity-25 bg-slate-100 dark:bg-slate-900`} />
            ...
            <div className="text-center pt-2">
              <Link to="/student-login" className="text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 flex items-center justify-center gap-1.5 transition-colors">
